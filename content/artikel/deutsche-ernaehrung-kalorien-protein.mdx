...
description: "Der Durchschnittsdeutsche isst ~3.000 kcal am Tag, viel zu viel Zucker — und schafft trotzdem kaum den Proteinbedarf. Was schief läuft und wie es besser geht."
category: "Grundlagen"
date: "2025-04-04"
...
Deutschland hat kein Hunger-Problem — sondern ein Qualitätsproblem. Laut der Nationalen Verzehrsstudie und dem DGE-Ernährungsbericht liegt die durchschnittliche Kalorienaufnahme bei Männern bei über 2.900 kcal, bei Frauen bei rund 2.100 kcal. Deutlich über dem, was die meisten tatsächlich brauchen. Gleichzeitig schaffen es viele kaum, ihren Proteinbedarf zu decken.

<StatBlock
  value="~3.000"
  label="kcal nehmen deutsche Männer durchschnittlich pro Tag zu sich"
...
Der typische deutsche Tag sieht oft so aus: Brötchen mit Butter und Marmelade zum Frühstück, Kantinenessen mittags, abends Brot mit Wurst und Käse. Dazu Snacks, Softdrinks, Saft. Klingt normal — ist aber eine Kalorienbombe mit wenig Protein.

### Was ein typischer deutscher Tag kostet
...
Die WHO empfiehlt maximal 50 g freien Zucker pro Tag (besser: unter 25 g). Deutsche Männer kommen laut DGE auf durchschnittlich **über 100 g Zucker täglich** — das Doppelte der Obergrenze. Der größte Teil kommt nicht aus der Zuckerdose, sondern versteckt: Saft, Fruchtjoghurt, Müsli, Soßen, Brot.

<StatBlock
  value="110 g"
  label="Zucker konsumieren deutsche Männer durchschnittlich pro Tag"
